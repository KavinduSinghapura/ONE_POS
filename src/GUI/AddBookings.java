...
public class AddBookings extends javax.swing.JDialog {
    ...
    private void loadRooms() {
        ...
        try {
            ...
            ResultSet resultSet = MySQL.executeSearch("SELECT * FROM `rooms`");
            ...
            while (resultSet.next()) {
                ...
                roomMap.put(resultSet.getString("name"), resultSet.getString("id"));
    ...
    private void loadStatus() {
        ...
        try {
            ...
            ResultSet resultSet = MySQL.executeSearch("SELECT * FROM `room_status`");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (nic.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Please Enter Days Count", "Warning", JOptionPane.WARNING_MESSAGE);
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    MySQL.executeIUD("INSERT INTO `room_bookings` (`days`,`checking_date`,`checkout_date`,`price`,`rooms_id`,`room_status_id`,`customer_id`) VALUES ('" + days + "','" + indate + "','" + outdate + "','" + price + "','" + roomMap.get(room) + "','" + statusMap.get(status) + "','" + c_id + "')");
